...
##' @rdname iroll
##' @export
iroll_sd <- function(ix, x, left, right = 0, left_open = FALSE, right_open = FALSE) {
...
##' @rdname iroll
##' @export
iroll_sum <- function(ix, x, left, right = 0, left_open = FALSE, right_open = FALSE) {
...
##' @rdname iroll
##' @export
iroll_prod <- function(ix, x, left, right = 0, left_open = FALSE, right_open = FALSE) {
